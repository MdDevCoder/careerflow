...
const formSchema = z.object({
  ...
  salary_min: z.preprocess((val) => (val === '' || Number.isNaN(Number(val)) ? null : Number(val)), z.number().nullable().optional()) as z.ZodType<number | null | undefined, any, any>,
  salary_max: z.preprocess((val) => (val === '' || Number.isNaN(Number(val)) ? null : Number(val)), z.number().nullable().optional()) as z.ZodType<number | null | undefined, any, any>,
